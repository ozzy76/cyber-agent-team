...
* Why is this relevant to your consumer?  
* For example: does it have the potential to undermine existing security controls? Does it have the potential to undermine earnings in each geographic region? Does it present an opportunity to move into a new market space?  
...
| Data Sources:             | Cite external CTI Report with hyperlink if available. Cite Internal Telemetry sources provided by the SOC as needed. This field is not designed to preserve telemetry data and should only include data necessary to justify the analytic assessments.  |
| :---- | :---- |
